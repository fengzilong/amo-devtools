(function (global, factory) {
  ...
  (factory((global.panel = global.panel || {})));
...
var reo = createCommonjsModule(function (module, exports) {
(function (global, factory) {
...
var slice = [].slice;
var o2str = ({}).toString;
var win = typeof window !=='undefined'? window: commonjsGlobal$$1;
...
var dom_1 = createCommonjsModule$$1(function (module) {
...
var combine_1 = createCommonjsModule$$1(function (module) {
...
var walkers_1 = createCommonjsModule$$1(function (module) {
...
var filter$1 = createCommonjsModule$$1(function (module) {
...
var base = createCommonjsModule$$1(function (module) {
// Regular
var _ = util;
var dom = dom_1;
var animate = animate_1;
...
var eventemitter2 = createCommonjsModule$$1(function (module, exports) {
/*!
 * EventEmitter2
...
var regularRouter = createCommonjsModule$$1(function (module, exports) {
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
  typeof define === 'function' && define.amd ? define(factory) :
...
var DiffState = {
	...
	config: function config() {
		...
		this.$watch( 'current', function () { return this$1.renderDiff(); } );
	},
	init: function init() {
		this.renderDiff();
	},
	renderDiff: function renderDiff() {
		...
		var oldState = ( history[ current - 1 ] && history[ current - 1 ].state ) || baseState;
		var newState = ( history[ current ] && history[ current ].state ) || baseState;

		var delta = jsondiff.diff( oldState, newState );
...
var FullState = {
	computed: {
		...
		state: function state() {
			...
			var history = this.$get( 'history' );
			var current = this.$get( 'current' );
			var state = ( history[ current ] && history[ current ].state ) || base.state;
			return state;
		}
	},
	components: {
...
var App = {
	...
	components: {
		Actions: Actions, DiffState: DiffState, Tabs: Tabs, ActionJSON: ActionJSON, FullState: FullState
	},
...
var tabs = {
	...
	reducers: {
		select: function select( state, key ) {
			state.selected = key;
		}
	}
};
...
var actions = {
	...
	travelByIndex: function travelByIndex( ref, index ) {
		...
		var base = get( 'base' );
		var record = history[ index ] || base;
		dispatch( 'travel', record );
	},
	setBaseState: function setBaseState( ref, state ) {
		var commit = ref.commit;

		var time = Date.now();
		var formattedTime = formatTime( Date.now() );
		commit( 'history/base', {
			time: time,
	...
	purgeState: function purgeState( ref ) {
		var commit = ref.commit;

		commit( 'history/clear' );
	},
	addRecord: function addRecord( ref, record ) {
		var commit = ref.commit;

		var time = Date.now();
		var formattedTime = formatTime( Date.now() );
		Object.assign( record, {
			time: time, formattedTime: formattedTime
		} );
	...
	backward: function backward( ref ) {
		var dispatch = ref.dispatch;
		var get = ref.get;
...
var getters = {
	base: function (state) { return state.history.base; },
	history: function (state) { return state.history.stack; },
	current: function (state) { return state.history.current; },
	tabSource: function (state) { return state.tabs.source; },
	selected: function (state) { return state.tabs.selected; },
};

var subscriptions = function (app) {
	var store = app.$store;
